                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="card" style="background-color: #ff4444;">
                                <div class="header">
                                   ...
                                   <a href="request_obat.php">Stok Obat</a>
                        ...
                        <div class="col-md-3">
                            <div class="card" style="background-color: #40E0D0;">
                                <div class="header">
                                   ...
                                   <a href="penjualan.php">Obat Terjual</a>
                                    <h1 style="color: #fff;padding: 10px;">
                        ...
                        <div class="col-md-3">
                            <div class="card" style="background-color: #00ff7f;">
                                <div class="header">
                                    <form action="obat.php" method="POST">
                                    <a href="obat.php">Obat Expired</a>
                                    <h1 style="color: #fff;padding: 10px;">
                                        <?php
                                        $tgl = date("Y-m-d");
                        ...
                        <?php if ($_SESSION['level'] == 'admin' || $_SESSION['level'] == 'apoteker' || $_SESSION['level'] == 'pegawai') { ?>
                            <div class="col-md-3">
                                <div class="card" style="background-color: #ffa500;">
                                    <div class="header">
                                        <h6> <a href="users.php">Users</a> <h1 style="color: #fff;padding: 10px;"><?= $jumlah['jumlah'] ?></h1>
                                        </h6>
                                    </div>
